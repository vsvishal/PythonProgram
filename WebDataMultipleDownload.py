    ...
    #---------------------------------------------------------------------
        ...
        def TEAutomateTask(part_num, row_num, website_name):
            ...
            try:
                ...
                TEAutomateTask(part_num, row_num, website_name)
        ...
        def MolexAutoTask(part_num, row_num, website_name):
            ...
            try:
                ...
                MolexAutoTask(part_num, row_num, website_name)
            ...
            try:
                # If part number not present on website
                if driver.find_elements_by_xpath("//div[@id='part_num']//h2"):
                    statusMsg = 'No'
                    putValuesInTemplateFile('No', 'No','No', statusMsg, row_num)
                    driver.close()
                    driver.quit()
                    ...
                    try:
                        # global sht_name
                        # category_1 = driver.find_elements_by_xpath("//div[@class='part-details']//li")[1].text
                        # category_2 = driver.find_elements_by_xpath("//div[@class='part-details']//li")[2].text
                        # if 'Crimp Housings' in category_1 or 'Crimp Housings' in category_2:
                        #     sht_name = 'Connector'
                        # elif 'Terminals' in category_1 or 'Terminals' in category_2:
                        #     sht_name = 'Terminal'
                        # else:
                        #     sht_name = 'Seal'
        ...
        # -------------------------------------------------------------------------------------
        # ---------------------------Aptiv(Delphi)---------------------------------------------
        def AptivAutomateTask(part_num, row_num, website_name):
            chromeOptions = Options()
            ...
            try:
                ...
                AptivAutomateTask(part_num, row_num, website_name)
            ...
            try:
                ...
                if zeroResultElement == partNo:
                    ...
                    try:
                        ...
                        # select sheet
                        # global sht_name
                        # attrib_value_row = pd_data.loc[pd_data['Attribute'] == 'Product Type']
                        # if attrib_value_row.empty:
                        #     sht_name = 'Seal'
                        # else:
                        #     attrib_ind = pd_data.index[pd_data['Attribute'] == 'Product Type'].tolist()
                        #     attrib_index = attrib_ind[0]
                        #     attrib_value = attrib_value_row.loc[attrib_index, 'Values']
                        #     if attrib_value == 'Connector':
                        #         sht_name = 'Connector'
                        #     elif attrib_value == 'Terminal':
                        #         sht_name = 'Other_Data'
        ...
        def Deutsch(part_num, row_num, website_name):
            ...
            # baseUrl = "https://laddinc.com/product/?sku=1060-14-0122"
        ...
        def Yazaki(part_num, row_num, website_name):
...
#multipleData = MutlipleWebDataDownload()
#multipleData.MainFunction()
